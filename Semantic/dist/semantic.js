...
$.fn.dropdown.settings = {
  ...
  message: {
    ...
    maxSelections : 'Número máximo de seleções: {maxCount}',
    noResults     : 'Nenhum resultado encontrado.',
    serverError   : 'Houve um erro ao consultar o servidor'
  },
...
$.fn.search.settings = {
  ...
  error : {
    ...
    noResults   : 'Sua pesquisa não retornou nenhum resultado',
    logging     : 'Error in debug logging, exiting.',
    noEndpoint  : 'No search endpoint was specified',
    noTemplate  : 'A valid template name was not specified.',
    serverError : 'Houve um problema ao consultar o servidor.',
  ...
  templates: {
    ...
    message: function(message, type) {
      ...
      if(message !== undefined && type !== undefined) {
        ...
        if(type == 'empty') {
          html += ''
            + '<div class="header">Sem Resultados</div class="header">'
